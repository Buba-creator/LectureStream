...
public class Platform_ActivityLifecycleContextListener
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("LibVLCSharp.Forms.Platforms.Android.Platform+ActivityLifecycleContextListener, LibVLCSharp.Forms", Platform_ActivityLifecycleContextListener.class, __md_methods);
	}


	public Platform_ActivityLifecycleContextListener ()
	{
		super ();
		if (getClass () == Platform_ActivityLifecycleContextListener.class)
			mono.android.TypeManager.Activate ("LibVLCSharp.Forms.Platforms.Android.Platform+ActivityLifecycleContextListener, LibVLCSharp.Forms", "", this, new java.lang.Object[] {  });
	}
